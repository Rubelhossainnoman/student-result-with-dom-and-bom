...
if (search_student_form) {
    search_student_form.onsubmit = (e) =>{
        ...
        if (!roll || !reg) {
            ...
            if(allStudents.find(data => data.roll == roll && allStudents.find(data=> data.reg == reg))){
                if (singleStudent.result === null) {
                    searchResultModal.click();
                    showFinalResult.innerHTML = `<p class="m-0 text-center" style="font-size: 20px;">No data added yet</p>`
                }else{
            ...
            }else if (allStudents.find(data=> data.roll == roll)) {
            ...
            }else if(allStudents.find(data=> data.reg == reg)){
